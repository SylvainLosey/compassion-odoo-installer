...
read -p "Enter path where you want Odoo installed [Default: /home/${USER}/compassion]: " INSTALL_PATH
...
sudo apt update
sudo apt install mr postgresql-10 postgresql-10-postgis-2.4 libcups2-dev python-dev libxml2 \
libxml2-dev libxslt1-dev libevent-dev libsasl2-dev libldap2-dev expect-dev python-lxml python-simplejson \
python-serial python-yaml python-cups python-mysqldb zbar-tools python-zbar node-less
